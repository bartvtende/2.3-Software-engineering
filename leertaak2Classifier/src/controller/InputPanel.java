...
public class InputPanel extends JPanel {
	...
	public InputPanel(Node tree) {
		...
		if (node.isLeaf()) {
			...
			Frame.frame.getQuestion().setText(
					"Heeft de auto " + node.getLabel() + "?");
			createButtons();
		}
	}

	/*
	 * private void buttonSetup(){ ja.addActionListener(new ActionListener(){
	 * 
	 * @Override public void actionPerformed(ActionEvent arg0) { // TODO add
	 * body }
	 * 
	 * });
	 * 
	 ...
	 * 
	 * @Override public void actionPerformed(ActionEvent e) { // TODO add body
	 * 
	 * }});
	 * 
	 * }
